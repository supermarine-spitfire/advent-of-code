...
def calculate_moves(head_position, tail_position, direction, move_head_and_tail):
    # Move the head.
           ...
           # Horizontal/vertical moves.
            if head_position.x == tail_position.x:
                ...
                if head_position.y > tail_position.y:
                    return "U", head_position.y - tail_position.y
                elif head_position.y <  tail_position.y:
                    return "D", tail_position.y - head_position.y
            elif head_position.y == tail_position.y:
                # Do a horizontal move.
                if head_position.x > tail_position.x:
                    return "R", head_position.x - tail_position.x
                elif head_position.x <  tail_position.x:
                    return "L", tail_position.x - head_position.x
...
#             cur_head, cur_tail = calculate_moves(
#                 head_position=cur_head,
#                 tail_position=cur_tail,
#                 direction=direction,
#                 move_head_and_tail=True
#             )
